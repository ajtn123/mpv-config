...
function Controls:init_options()
	...
	local shorthands = {
		['play-pause'] = 'cycle:pause:pause:no/yes=play_arrow?',
		menu = 'command:menu:script-binding uosc/menu-blurred?',
		subtitles = 'command:subtitles:script-binding uosc/subtitles#sub>0?',
		audio = 'command:graphic_eq:script-binding uosc/audio#audio>1?',
		['audio-device'] = 'command:speaker:script-binding uosc/audio-device?',
		video = 'command:theaters:script-binding uosc/video#video>1?',
		playlist = 'command:list_alt:script-binding uosc/playlist?',
		chapters = 'command:bookmark:script-binding uosc/chapters#chapters>0?',
		['editions'] = 'command:bookmarks:script-binding uosc/editions#editions>1?',
		['stream-quality'] = 'command:high_quality:script-binding uosc/stream-quality?',
